...
public class Tester {
        ...
        public static void main(String[] args) {
                ...
                Rent r1 = new Rent("David Cohen", new CarCar(1122233, 'B', "Mercedes", false),
                                new DateDate(12, 3, 2004),
                                new DateDate(6, 7, 2004));
                Rent r2 = new Rent("Israel Israeli", new CarCar(1234567, 'A', "Mazda", true),
                                new DateDate(6, 6, 2066),
                                new DateDate(12, 8, 2066));
                Rent r4 = new Rent("Noy Zohar", new CarCar(6666666, 'A', "Mazda", true),
                                new DateDate(6, 6, 2066),
                                new DateDate(12, 8, 2066));

                // Test Constructor(Rent r)
                System.out.println(
                                "Testing constructor(Rent r) with pick date of 12/3/2004 and printing the date using the getRent() and toString() methods:");
                ...
                // adding one rent
                success = comp1.addRent("David Cohen", new CarCar(1122233, 'B', "Mercedes", false),
                                new DateDate(2, 7, 2018),
                                new DateDate(6, 7, 2018));
                if (success == false)
                ...
                comp1.addRent("Moshe Levy", new CarCar(1000001, 'C', "Citroen", false), new DateDate(2, 7, 2018),
                                new DateDate(17, 7, 2018));
                comp1.addRent("Moshe Levy", new CarCar(1000001, 'C', "Citroen", false), new DateDate(2, 7, 2018),
                                new DateDate(17, 7, 2018));
                comp1.addRent("Ron Balon", new CarCar(1111111, 'C', "Renault", true), new DateDate(2, 7, 2018),
                                new DateDate(9, 7, 2018));
                comp1.addRent("Israel Israeli", new CarCar(1234567, 'A', "Mazda", true), new DateDate(2, 8, 2017),
                                new DateDate(11, 8, 2017));
                System.out.println(comp1);
                ...
                // System.out.println("The total sum of rent days in this company is: " +
                // comp1.getSumOfDays());

                // test averageRent() - should be 8.75
                // System.out.println("\nTesting averageRent():");
                // System.out.println("The average rent duration in this company is: " +
                // comp1.averageRent());
                ...
                // System.out.println("The car in the company that its return date is the
                // latest:\n" + comp1.lastCarRent());
                // System.out.println("Where it should be:\nid:1000001 type:C brand:Citroen
                // gear:auto");

                // test longestRent() - should be 15
                // System.out.println("\nTesting longestRent():");
                // Rent longRent = comp1.longestRent();
                // System.out.println("The longest rent duration in this company is: " +
                // longRent.howManyDays());

                // // test mostCommonRate() - should be 'C'
                // System.out.println("\nTesting mostCommonRate():");
                // System.out.println("The most common rate in this company is: " +
                // comp1.mostCommonRate());

                // test removeRent(Date d) - removing one rent
                System.out.println("\nTesting removeRent(Date d):");
                success = comp1.removeRent(new DateDate(9, 7, 2018));
                if (success == false)
                ...
                // comp2.addRent("Moshe Levy", new Car(1000001, 'C', "Citroen", false), new
                // Date(2, 7, 2018),
                // new Date(17, 7, 2018));
                // comp2.addRent("Israel Israeli", new Car(1234567, 'A', "Mazda", true), new
                // Date(2, 8, 2017),
                // new Date(11, 8, 2017));
                // System.out.println("Testing includes():");
                // System.out.println(
                // "Testing includes with company that is included in another one should return
                // true while student code returns: "
                // + comp1.includes(comp2));

                // // test merge() - merge comp1 with comp3
                // Company comp3 = new Company();
                // comp3.addRent("Moshe Levy", new Car(1000001, 'C', "Citroen", false), new
                // Date(2, 7, 2018),
                // new Date(17, 7, 2018));
                // comp3.addRent("Johnatan Blum", new Car(1222221, 'B', "Renault", false), new
                // Date(13, 9, 2018),
                // new Date(16, 9, 2018));
                // comp3.addRent("Israel Israeli", new Car(1234567, 'A', "Mazda", true), new
                // Date(2, 8, 2017),
                // new Date(11, 8, 2017));
                // comp1.merge(comp3);
                // System.out.println(
                // "\nTesting merge() - Only \"Johnatan Blum\" should be added since the other
                // three rents already exists:");
                // System.out.println(comp1);
