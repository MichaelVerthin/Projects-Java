...
public class DateStudentTester {
     public static void main(String[] args) {
          ...
          DateDate d1 = new DateDate(3, 5, 1998);
          System.out.println("\td1:" + d1);
          DateDate d2 = new DateDate(d1);
          ...
          DateDate d3 = new DateDate(3, 5, 1998);
          DateDate d4 = new DateDate(3, 5, 1998);
          ...
          DateDate d6 = new DateDate(6, 11, 2016);
          System.out.println("\t" + d6 + " tomorrow is : " + d6.tomorrow());
          DateDate d7 = new DateDate(31, 12, 2019);
