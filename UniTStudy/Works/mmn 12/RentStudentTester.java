...
public class RentStudentTester {
    public static void main(String[] args) {
        ...
        Rent r1 = new Rent("Ruthi", new CarCar(1234567, 'A', "Opel", false), new DateDate(1, 2, 2020),
                new DateDate(5, 2, 2020));
        System.out.println("\tr1:" + r1);
        Rent r2 = new Rent(r1);
        System.out.println("\tr2:" + r2);
        System.out.println("\n2. Testing accessors and mutators:");
        r1.setName("Maya");
        r1.setCar(new CarCar(9876543, 'B', "BMW", true));
        r1.setPickDate(new DateDate(3, 2, 2020));
        r1.setReturnDate(new DateDate(9, 2, 2020));
        System.out.println("\tr1:" + r1);
        ...
        Rent r3 = new Rent("Rambo", new CarCar(3344556, 'D', "Volvo", false), new DateDate(10, 4, 2021),
                new DateDate(20, 4, 2021));
        Rent r4 = new Rent("Rambo", new CarCar(1234567, 'D', "Volvo", false), new DateDate(10, 4, 2021),
                new DateDate(20, 4, 2021));
        System.out.println("\tr2:" + r2);
        ...
        System.out
                .println("\tupgrade r2 to car type 'D' returns: "
                        + r2.upgrade(new CarCar(1234567, 'D', "Volvo", false)));
        System.out.println("\n7. Testing overlap method:");
        Rent r5 = new Rent("Bob", new CarCar(1234567, 'A', "Opel", false), new DateDate(1, 2, 2020),
                new DateDate(5, 2, 2020));
        Rent r6 = new Rent("Bob", new CarCar(1234567, 'A', "Opel", false), new DateDate(4, 2, 2020),
                new DateDate(8, 2, 2020));
